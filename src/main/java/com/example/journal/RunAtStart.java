...
public class RunAtStart {
	...
	public void runAtStart() {
		Caretaker c1 = new Caretaker("aaa", "bbb", "111", "ccc", "ddd");
		Caretaker c2 = new Caretaker("bbb", "ccc", "222", "ddd", "eee");
		...
		Student s1 = new Student("aaa", "bbb", "111", "ccc", "ddd", c2.getId(),y1.getId());
